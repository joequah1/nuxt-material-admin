          ...
          <v-layout row wrap class="grey lighten-4 pa-3">
            <v-flex xs4>
              <div class="layout column justify-center align-center">
                <v-btn icon outlinedd color="indigo">
            ...
            <v-flex xs4>
              <div class="layout column justify-center align-center">
                <v-btn icon outlinedd color="pink">
            ...
            <v-flex xs4>
              <div class="layout column justify-center align-center">
                <v-btn icon outlinedd color="blue">
                    ...
                    <v-list two-line class="pa-0">
                      ...
                      <v-list-item href="#">
                        ...
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle>{{user.address.city}}, {{user.address.state}}
